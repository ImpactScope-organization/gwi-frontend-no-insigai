...
export const scoringPagePrompts = {
  ...
  vagueTerms: {
    role: "system",
    content: `With the help of online research, Return a number from 0 to 3 if the company uses recurring vague claims related to greenwashing. Where 3 is the most frequent level of use. 0 is the lowest usage level.`,
  },
  lackOfQuantitativeData: {
    role: "system",
    content: `With the help of online research, Return a number from 0 and 3 if the company does not provide any quantitative data related to sustainability. Where 0 - if the company supports each statement with quantitative data. 3 - if the company does not provide any quantitative data.`,
  },
  scope3Emissions: {
    role: "system",
    content: `With the help of online research, Return 0 if the company the company claims its target covers all Scope 3 emissions, in other words its full value chain, including downstream and upstream emissions. Return 1 if the company claims its target covers part of its Scope 3 emissions, for example its upstream (or suppliers) emissions. Return 2 if the company does not include Scope 3 emissions in its target or fails to specify whether it does or not.`,
  },
  externalOffset: {
    role: "system",
    content: `With the help of online research, Return 0 if the company has ruled out using external offset credits to meet part of its target. Return 1 if the company plans to use credits to meet part of its target, but provides at least one condition to qualify their use. Return 2 if the company either has not specified details about its planned use of credits or the company plans to use credits without providing any conditions to their use.`,
  },
  netZero: {
    role: "system",
    content: `With the help of online research, Return 0 If the company the company has included all four conditions of what is determined as a detailed plan. 1. Measures for all emission scopes that are covered by the target. For example, if the target covers all gases, but the plan only addresses carbon, this would not be met. 
  ...
  targetTimelines: {
    role: "system",
    content: `With the help of online research, Return 0 if the company claims its targets with timelines and 1 if doesn't.`,
  },
  stakeholdersEngagement: {
    role: "system",
    content: `With the help of online research, Return 0 if the information about stakerholders engagement present and 1 if doesn't.`,
  },
  reportsAnnually: {
    role: "system",
    content: `With the help of online research, Return 0 if the company reports annually. Return 1 if the company reports less than annualy. Return 2 if the company does not report.`,
  },
  sustainabilityInformationExists: {
    role: "system",
    content: `With the help of online research, Return 0 if the information about sustainability reporting framework (i.e. GRI, Integrated Reporting, SASB, UNGC, etc.) is presented. And 1 if it is not.`,
  },
  materialityAssessment: {
    role: "system",
    content: `With the help of online research, Return 0 if the information of materiality assessment in sustainability report is presented. And 1 if it is not.`,
  },
};
